        ...
        <div className="max-w-md sm:max-w-xl mx-auto space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-0 sm:flex sm:gap-3">
            <input
              ...
              className="w-full sm:flex-1 h-12 bg-white border border-brand-border rounded-xl px-4 text-sm text-brand-black placeholder-brand-gray outline-none focus:ring-2 focus:ring-primary transition-all uppercase placeholder:normal-case"
            />
            <button
              type="submit"
              className="w-full sm:w-auto sm:shrink-0 h-12 px-6 bg-primary hover:bg-primary-hover text-white font-bold uppercase tracking-wider text-xs rounded-xl transition-all shadow-sm flex items-center justify-center gap-2 active:scale-[0.98]"
            >
